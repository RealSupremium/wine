...
typedef void (*bitsputfunc)(const IDirectSoundBufferImpl *dsb, float volume, DWORD channel, DWORD count, float *values);
...
void putsamples_mono2stereo(const IDirectSoundBufferImpl *dsb, float volume, DWORD channel, DWORD count, float *value);
void putsamples_mono2quad(const IDirectSoundBufferImpl *dsb, float volume, DWORD channel, DWORD count, float *value);
void putsamples_stereo2quad(const IDirectSoundBufferImpl *dsb, float volume, DWORD channel, DWORD count, float *value);
void putsamples_mono2surround51(const IDirectSoundBufferImpl *dsb, float volume, DWORD channel, DWORD count, float *value);
void putsamples_stereo2surround51(const IDirectSoundBufferImpl *dsb, float volume, DWORD channel, DWORD count, float *value);
void putsamples_surround512stereo(const IDirectSoundBufferImpl *dsb, float volume, DWORD channel, DWORD count, float *value);
void putsamples_surround712stereo(const IDirectSoundBufferImpl *dsb, float volume, DWORD channel, DWORD count, float *value);
void putsamples_quad2stereo(const IDirectSoundBufferImpl *dsb, float volume, DWORD channel, DWORD count, float *value);
