...
Sub testCDecStub
    on error resume next
    Err.Clear : call CDec(0)        : todo_wine_ok Err.Number = 13, "CDec(0) err=" & Err.Number
    Err.Clear : call CDec(1.5)      : todo_wine_ok Err.Number = 13, "CDec(1.5) err=" & Err.Number
    Err.Clear : call CDec("1.5")    : todo_wine_ok Err.Number = 13, "CDec(""1.5"") err=" & Err.Number
    Err.Clear : call CDec(Null)     : todo_wine_ok Err.Number = 13, "CDec(Null) err=" & Err.Number
    Err.Clear : call CDec(Empty)    : todo_wine_ok Err.Number = 13, "CDec(Empty) err=" & Err.Number
End Sub
Call testCDecStub
