...
static inline ALPC_PORT_MESSAGE *alpc_port_message_32to64( ALPC_PORT_MESSAGE *out,
                                                                            ...
                                                                            BOOL copy_attributes )
{
    ...
    if (in->ValidAttributes & ALPC_MESSAGE_SECURITY_ATTRIBUTE)
    {
        ...
        ALPC_SECURITY_ATTR *to_attr = AlpcGetMessageAttribute( out, ALPC_MESSAGE_SECURITY_ATTRIBUTE );
        ...
        {
            qos32 = (SECURITY_QUALITY_OF_SERVICE32 *)ULongToPtr( from_attr->QoSPointer );
            to_attr->QoS = qos;
    ...
    if (in->ValidAttributes & ALPC_MESSAGE_VIEW_ATTRIBUTE)
    {
        ...
        ALPC_VIEW_ATTR *to_attr = AlpcGetMessageAttribute( out, ALPC_MESSAGE_VIEW_ATTRIBUTE );
    ...
    if (in->ValidAttributes & ALPC_MESSAGE_CONTEXT_ATTRIBUTE)
    {
        ...
        ALPC_CONTEXT_ATTR *to_attr = AlpcGetMessageAttribute( out, ALPC_MESSAGE_CONTEXT_ATTRIBUTE );
    ...
    if (in->ValidAttributes & ALPC_MESSAGE_HANDLE_ATTRIBUTE)
    {
        ...
        ALPC_HANDLE_ATTR *to_attr = AlpcGetMessageAttribute( out, ALPC_MESSAGE_HANDLE_ATTRIBUTE );
    ...
    if (in->ValidAttributes & ALPC_MESSAGE_TOKEN_ATTRIBUTE)
    {
        ...
        ALPC_TOKEN_ATTR *to_attr = AlpcGetMessageAttribute( out, ALPC_MESSAGE_TOKEN_ATTRIBUTE );
    ...
    if (in->ValidAttributes & ALPC_MESSAGE_DIRECT_ATTRIBUTE)
    {
        ...
        ALPC_DIRECT_ATTR *to_attr = AlpcGetMessageAttribute( out, ALPC_MESSAGE_DIRECT_ATTRIBUTE );
    ...
    if (in->ValidAttributes & ALPC_MESSAGE_WORK_ON_BEHALF_ATTRIBUTE)
    {
        ...
        ALPC_WORK_ON_BEHALF_ATTR *to_attr = AlpcGetMessageAttribute( out, ALPC_MESSAGE_WORK_ON_BEHALF_ATTRIBUTE );
